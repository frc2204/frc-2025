...
object ElevatorConstants {
    ...
    val ELEVATOR_PID_DEC2 = PIDConstants(0.60, 0.0, 0.0)
    ...
    const val DUTY_CYCLE_CLOSED_LOOP_RAMP_PERIOD = 0.20
    const val VOLTAGE_CLOSED_LOOP_RAMP_PERIOD = 0.20
