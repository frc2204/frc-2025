...
object ElevatorConstants {
    ...
    /** must be tuned later */
    val ELEVATOR_PID = PIDConstants(0.8, 0.0, 0.0)
    val ELEVATOR_PID_DEC1 = PIDConstants(0.125, 0.0, 0.0)
    val ELEVATOR_PID_DEC2 = PIDConstants(0.125, 0.0, 0.0) //just lowering for auton
    ...
    const val DUTY_CYCLE_CLOSED_LOOP_RAMP_PERIOD = 0.15
    const val VOLTAGE_CLOSED_LOOP_RAMP_PERIOD = 0.15
//
//    private const val L1_OFFSET = 1.2
//    private const val L2_OFFSET = 2.1
//    private const val L3_OFFSET = 3.5
//    private const val L4_OFFSET = 5.6
