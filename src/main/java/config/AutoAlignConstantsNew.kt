...
object AutoAlignConstantsNew {
    ...
    val ALIGN_REEF3_LEFT_POSE = Pose2d(3.709, 3.011, Rotation2d.fromDegrees(60.0))
    val ALIGN_REEF3_RIGHT_POSE = Pose2d(1.232, 0.723, Rotation2d.fromDegrees(60.0))

    val ALIGN_REEF4_LEFT_POSE = Pose2d(3.220, 4.190, Rotation2d.fromDegrees(0.0))
