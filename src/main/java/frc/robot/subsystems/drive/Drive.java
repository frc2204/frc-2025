...
public class Drive extends SubsystemBase {
  ...
  private static final double ROBOT_MASS_KG = 56.699;
  private static final double ROBOT_MOI = 4.11642;
  ...
  public Drive(
    ...
    // logging swerve to elastic
    Logger.recordOutput("ServeVelocity", getChassisSpeeds());
    ...
    AutoBuilder.configure(
        ...
        new PPHolonomicDriveController(
            new PIDConstants(10.50, 0.0, 0.0), new PIDConstants(12.0, 0.0, 0.0)),
        PP_CONFIG,
