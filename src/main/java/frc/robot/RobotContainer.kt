...
//        controller.leftBumper().onFalse(SourceIntakeHome())
        ...
        /** Source auto align */
//        xBoxController.leftBumper().whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_SOURCE_1))
        ps5Controller.L2()
            .and(ps5Controller.povLeft()).whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_SOURCE_1))
//        xBoxController.rightBumper().whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_SOURCE_2))
        ps5Controller.R2()
            .and(ps5Controller.povLeft()).whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_SOURCE_2))
...
//        controller.x().and(controller.povRight().whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_REEF4_Right)))
        ...
        // changed auto align for reef 1 and 4 to dpad + triggers
        ps5Controller.povUp()
            .and(ps5Controller.L2()).whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_REEF1_Left))

        ps5Controller.povUp()
            .and(ps5Controller.R2()).whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_REEF1_Right))

        ps5Controller.povDown()
            .and(ps5Controller.L2()).whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_REEF4_Left))

        ps5Controller.povDown()
            .and(ps5Controller.R2()).whileTrue(AutoAlign.pathFind(AutoAlignConstants.ALIGN_REEF4_Right))
    }
